...
async function main() {
  ...
  await prisma.userZone.createMany({ data: [
  ...
  const txs = [
    { code: genCode(), sourceAmount:20000, sourceCurrency:'EUR', destAmount:13040000, destCurrency:'XOF', appliedRate:652.0,    rateSource:'MANUAL', sourceZoneId:fr.id, destZoneId:sn.id, senderAgentId:ap1.id, receiverAgentId:adk.id, recipientName:'Fatou Diallo',    status:'COMPLETED', confirmedAt:ago(48)  },
    { code: genCode(), sourceAmount:5000,  sourceCurrency:'EUR', destAmount:3260000,  destCurrency:'XOF', appliedRate:652.0,    rateSource:'MANUAL', sourceZoneId:fr.id, destZoneId:sn.id, senderAgentId:ap1.id, receiverAgentId:adk.id, recipientName:'Mamadou Ndiaye',  status:'COMPLETED', confirmedAt:ago(72)  },
    { code: genCode(), sourceAmount:10000, sourceCurrency:'EUR', destAmount:6520000,  destCurrency:'XOF', appliedRate:652.0,    rateSource:'MANUAL', sourceZoneId:fr.id, destZoneId:sn.id, senderAgentId:ap2.id, receiverAgentId:adk.id, recipientName:'Rokhaya Fall',    status:'COMPLETED', confirmedAt:ago(24)  },
    { code: genCode(), sourceAmount:30000, sourceCurrency:'EUR', destAmount:19560000, destCurrency:'XOF', appliedRate:652.0,    rateSource:'MANUAL', sourceZoneId:fr.id, destZoneId:sn.id, senderAgentId:ap1.id, receiverAgentId:adk.id, recipientName:'Ibrahima Ba',     status:'COMPLETED', confirmedAt:ago(120) },
    { code: pc1,       sourceAmount:15000, sourceCurrency:'EUR', destAmount:9780000,  destCurrency:'XOF', appliedRate:652.0,    rateSource:'MANUAL', sourceZoneId:fr.id, destZoneId:sn.id, senderAgentId:ap1.id,                         recipientName:'Aissatou Sow',   status:'PENDING',   expiresAt:fromNow(46) },
    { code: pc2,       sourceAmount:25000, sourceCurrency:'EUR', destAmount:16300000, destCurrency:'XOF', appliedRate:652.0,    rateSource:'MANUAL', sourceZoneId:fr.id, destZoneId:sn.id, senderAgentId:ap2.id,                         recipientName:'Ousmane Ndiaye', status:'PENDING',   expiresAt:fromNow(24) },
    { code: genCode(), sourceAmount:30000, sourceCurrency:'EUR', destAmount:325500,   destCurrency:'MAD', appliedRate:10.85,    rateSource:'API',    sourceZoneId:fr.id, destZoneId:ma.id, senderAgentId:ap1.id, receiverAgentId:acs.id, recipientName:'Mohamed Tazi',   status:'COMPLETED', confirmedAt:ago(5)   },
    { code: genCode(), sourceAmount:8000,  sourceCurrency:'EUR', destAmount:86800,    destCurrency:'MAD', appliedRate:10.85,    rateSource:'API',    sourceZoneId:fr.id, destZoneId:ma.id, senderAgentId:ap2.id, receiverAgentId:acs.id, recipientName:'Zineb Alaoui',   status:'COMPLETED', confirmedAt:ago(36)  },
    { code: genCode(), sourceAmount:5000,  sourceCurrency:'EUR', destAmount:7490,     destCurrency:'CAD', appliedRate:1.498,    rateSource:'API',    sourceZoneId:fr.id, destZoneId:ca.id, senderAgentId:ap1.id, receiverAgentId:amt.id, recipientName:'Sarah Tremblay', status:'COMPLETED', confirmedAt:ago(12)  },
    { code: pc3,       sourceAmount:2000,  sourceCurrency:'EUR', destAmount:290400,   destCurrency:'DZD', appliedRate:145.2,    rateSource:'API',    sourceZoneId:fr.id, destZoneId:dz.id, senderAgentId:ap1.id,                         recipientName:'Yacine Boudiaf', status:'PENDING',   expiresAt:fromNow(40) },
    { code: genCode(), sourceAmount:10000, sourceCurrency:'EUR', destAmount:6520000,  destCurrency:'XOF', appliedRate:652.0,    rateSource:'MANUAL', sourceZoneId:fr.id, destZoneId:sn.id, senderAgentId:ap1.id,                         recipientName:'Lamine Sall',    status:'CANCELLED', cancelledAt:ago(3),  cancelReason:'Client a change d avis' },
    { code: genCode(), sourceAmount:3000,  sourceCurrency:'EUR', destAmount:32550,    destCurrency:'MAD', appliedRate:10.85,    rateSource:'API',    sourceZoneId:fr.id, destZoneId:ma.id, senderAgentId:ap2.id,                         recipientName:'Hassan Rami',    status:'CANCELLED', cancelledAt:ago(8),  cancelReason:'Erreur de saisie'       },
    { code: genCode(), sourceAmount:7500,  sourceCurrency:'EUR', destAmount:4890000,  destCurrency:'XOF', appliedRate:652.0,    rateSource:'MANUAL', sourceZoneId:fr.id, destZoneId:sn.id, senderAgentId:ap1.id,                         recipientName:'Seydou Camara',  status:'EXPIRED',   expiresAt:ago(5)     },
    { code: genCode(), sourceAmount:1500,  sourceCurrency:'EUR', destAmount:217800,   destCurrency:'DZD', appliedRate:145.2,    rateSource:'API',    sourceZoneId:fr.id, destZoneId:dz.id, senderAgentId:ap2.id,                         recipientName:'Riad Cherif',    status:'EXPIRED',   expiresAt:ago(2)     },
    { code: genCode(), sourceAmount:500000,sourceCurrency:'XOF', destAmount:762,      destCurrency:'EUR', appliedRate:0.001524, rateSource:'API',    sourceZoneId:sn.id, destZoneId:fr.id, senderAgentId:adk.id, receiverAgentId:ap1.id, recipientName:'Marc Girard',    status:'COMPLETED', confirmedAt:ago(2)   },
    { code: genCode(), sourceAmount:3000,  sourceCurrency:'CAD', destAmount:1312740,  destCurrency:'XOF', appliedRate:437.58,   rateSource:'API',    sourceZoneId:ca.id, destZoneId:sn.id, senderAgentId:amt.id, receiverAgentId:adk.id, recipientName:'Bintou Kone',    status:'COMPLETED', confirmedAt:ago(18)  },
    { code: genCode(), sourceAmount:2000,  sourceCurrency:'CAD', destAmount:875160,   destCurrency:'XOF', appliedRate:437.58,   rateSource:'API',    sourceZoneId:ca.id, destZoneId:sn.id, senderAgentId:amt.id,                         recipientName:'Adama Kouyate',  status:'PENDING',   expiresAt:fromNow(38) },
  ];
